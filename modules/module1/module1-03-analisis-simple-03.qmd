...
#| setup: true
#| results: hide
download.file("https://open.neotomadb.org/R-workshop/webr_repo/data/saDownload.RDS", destfile = "saDownload.RDS", mode = "wb")
...
png("strat_plot.png", width = 1200, height = 800, res = 150)
...
[img](images/plotStrigraphraw-1.png)
